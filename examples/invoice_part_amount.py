...
##
# 3. Get the adress associated with the purchase/invoice
#

invno = sys.argv[1]

# Specify for which article(s) you want the amout
# artno must be the same as the one used in add_article when you made the
# add_transaction call
k.add_art_no(qty=1, artno='MG200MMS')

try:
	amount = k.invoice_part_amount(invno)

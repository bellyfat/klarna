...
##
# 3. Invoke activate_invocie and
#

try:
	# You can specify country (and language, currency if you wish) if you don't
	# want to use the configured country
	k.fetch_pclasses()

	# PClasses fetched, now you can use get_pclasses to load them locally or
	# get_pclass to load a specific PClass locally
except Exception, e:
